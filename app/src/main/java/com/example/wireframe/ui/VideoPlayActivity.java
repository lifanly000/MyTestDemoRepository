 ...
 * 
 */
public class VideoPlayActivity extends BaseActivity implements ProtocalEngineObserver, OnClickListener{
...
//	private WebView webview ;
	...
	private RelativeLayout zan_comment_ll ;
	...
	private void fillCommentData(String time) {
	...
	class MyCommentAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			TextView tv = new TextView(VideoPlayActivity.this);
			String htmlStr = "";
...
//		videowebview.loadUrl(url);
		...
		zan_comment_ll = (RelativeLayout) findViewById(R.id.zan_comment_ll);
...
//		            WindowManager.LayoutParams.FLAG_FORCE_NOT_FULLSCREEN);
    	...
    	//网页标题
         ...
         public void onReceivedTitle(WebView view, String title) {
            (VideoPlayActivity.this).setTitle(title);
         }
            ...
            if(MotionEvent.ACTION_DOWN == event.getAction()){  
                ...
                if(count == 1){  
                    ...
                    if(secClick - firClick < 500){  
                        //双击事件  
                          Toast.makeText(VideoPlayActivity.this, "双击了屏幕", Toast.LENGTH_LONG).show();
                    } 
                    else {
...
//				titleHead.setText(data.title);
				...
				fillCommentData(data.publishTime);
			}else{
