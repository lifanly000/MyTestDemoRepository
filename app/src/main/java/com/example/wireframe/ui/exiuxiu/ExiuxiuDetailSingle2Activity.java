...
import com.example.wireframe.ui.VideoPlayActivity.xWebChromeClient;
import com.example.wireframe.ui.VideoPlayActivity.xWebViewClientent;
import com.example.wireframe.utils.ShareUtil;
import com.example.wireframe.view.ListViewInScroll;
import com.nostra13.universalimageloader.core.DisplayImageOptions;
import com.nostra13.universalimageloader.core.ImageLoader;

public class ExiuxiuDetailSingle2Activity extends BaseActivity implements OnClickListener, ProtocalEngineObserver {
...
//			intent.putExtra("url", videoPageUrl);
			intent.putExtra("eShowId", workId);
...
//			finish();
	...
	class MyCommentAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			TextView tv = new TextView(ExiuxiuDetailSingle2Activity.this);
			String htmlStr = "";
...
//			       		 mTestWebView.loadData("", "text/html; charset=UTF-8", null);
			   			ExiuxiuDetailSingle2Activity.this.finish();
			       		 Log.i("testwebview", "===>>>2");
						}
		    	}
		    	return true;
...
//					setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT); 
			...
			public View getVideoLoadingProgressView() {
		        ...
		        if (xprogressvideo == null) {
		            LayoutInflater inflater = LayoutInflater.from(ExiuxiuDetailSingle2Activity.this);
	    	...
	    	//网页标题
	         ...
	         public void onReceivedTitle(WebView view, String title) {
	            (ExiuxiuDetailSingle2Activity.this).setTitle(title);
	         }
	            ...
	            if(MotionEvent.ACTION_DOWN == event.getAction()){  
	                ...
	                if(count == 1){  
	                    ...
	                    if(secClick - firClick < 500){  
	                        //双击事件  
	                          Toast.makeText(ExiuxiuDetailSingle2Activity.this, "双击了屏幕", Toast.LENGTH_LONG).show();
	                    } 
	                    else {
